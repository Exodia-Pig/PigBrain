...
[구 블로그 주소](https://mccoy-devloper.tistory.com/) 한번쓰면 수정을 안해서 똥글 투성이
...
## OOP
### pattern
- [pattern_퍼사드_패턴.md](https://github.com/Exodia-Pig/PigBrain/tree/main/docs/OOP/pattern/pattern_퍼사드_패턴.md)
### solid
